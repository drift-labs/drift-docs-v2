...
These risk parameters are relevant to perpetual futures. Further risk parameters are also set out in and (Risk Parameters)[/risk-and-safety/risk-parameters].
