...
These risk parameters are relevant to perpetual futures. Further risk parameters are also set out in and (Risk Parameters)[pages/risk-and-safety/risk-parameters.mdx].
...
This risk is addressed in [**Risks**](pages/security/risks.mdx) and [**P&L**](pages/profit-loss/profit-loss-intro.mdx).
...
In a circumstance where the majority of participants are in extreme positive unrealised P&L and the unrealised P&L cannot be settled; the market may be eligible for settlement through the [**Delisting Process**](pages/risk-and-safety/delisting-process.mdx).
