...
This tutorial shows how to run a JIT Maker bot in Typescript. A similar example is available at https://github.com/drift-labs/keepyrs
...
```
git clone git@github.com:drift-labs/keeper-bots-v2.git
```


### 2. Prepare a keypair and drift account.

Refer to the [bot wallet setup](../../getting-started/wallet-setup/bot-wallet-setup.mdx) tutorial for how to set up a bot wallet.
...
* `global.endpoint`: set this to your RPC endpoint (see [RPC Providers](./rpc-providers.mdx))
