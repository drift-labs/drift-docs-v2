...
Follow the instructions at [**Keeper Bots**](/tutorial-bots/keeper-bots) to set the required environment variables, initialise the`ClearingHouseUser` and deposit some collateral.
