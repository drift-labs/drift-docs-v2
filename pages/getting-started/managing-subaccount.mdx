...
![Account Menu](public/assets/vyi6ndY7NLKNxsgOKwlul_accountswitch.png)

2\. Click "Add Subaccount."

![Account Dropdown](public/assets/4p3uxGuLrHi_3RxxEXGd-_subaccount.png)
...
![Adding a New Subaccount](public/assets/G648H8RneRHotAOLTrdjP_typeadd-account-wallet-statefocused.png)
...
*Deleting an account deletes the history attached to that adress and there is no backup for this.
...
![](public/assets/fwwcCcRroK8pA4hGg_L9B_screen-shot-2022-10-18-at-62504-pm.png)
...
![](public/assets/-fvDPAylp8Kc0Ais_6BkA_collateral.png)
