...
_For more information on incentive programs for Market Makers, see_ [**Maker Rebate Fees**](pages/market-makers/maker-rebate-fees.mdx)

## Introduction

Any user can participate as a Market Maker on the platform. Market Makers can provide liquidity through either:  

1.  Just-in-Time Liquidity (see [**Just-In-Time (JIT) Auctions**](pages/about-v2/jit-auctions.mdx)); or

2.  Post-Only Orders on the decentralised orderbook (see [**Keepers & Decentralised Orderbook**](pages/about-v2/keepers-decentralized-orderbook-faq.mdx)).
...
Market Makers can participate in the JIT system by running a JIT Maker Bot. For more information, check out [**Tutorial: JIT Maker Bot**](pages/developer-resources/tutorial-bots/trading-bots/tutorial-jit-trading-bot.mdx)

For more information on the Just-in-Time Liquidity system, check out [**Just-In-Time (JIT) Auctions**](pages/about-v2/jit-auctions.mdx).

## Decentralised Orderbook  

Makers can also provide liquidity to Drift's decentralised orderbook by quoting via the UI or programmatically through the [**SDK Documentation**](pages/developer-resources/sdk-documentation.mdx)  
