...
Market Makers can participate in the JIT system by running a JIT Maker Bot. For more information, check out [**Tutorial: JIT Maker Bot**](/developer-resources/tutorial-bots/trading-bots/tutorial-jit-trading-bot)
...
Makers can also provide liquidity to Drift's decentralised orderbook by quoting via the UI or programmatically through the [**SDK Documentation**](/developer-resources/sdk-documentation)  
