...
Follow the instructions at [**Keeper Bots**](/about-v2/keepers) to set the required environment variables, initialise the`ClearingHouseUser` and deposit some collateral.
