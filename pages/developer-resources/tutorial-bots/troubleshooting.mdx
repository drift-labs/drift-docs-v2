...
The account in `KEEPER_PRIVATE_KEY` has not been initialised on the `ClearingHouse` program yet. See [**Keeper Bots**](/about-v2/keepers) for how to initialise the `ClearingHouseUser`
