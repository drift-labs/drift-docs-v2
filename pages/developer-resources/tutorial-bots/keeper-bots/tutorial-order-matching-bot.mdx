...
Matching Bots are similar to [**Tutorial: Order Trigger Bot**](/developer-resources/tutorial-bots/keeper-bots/tutorial-order-trigger-bot) in that they:
...
Market orders that are sent on the Drift Protocol first go through the [**Just-In-Time (JIT) Auctions**](/about-v2/jit-auctions). After the auction period, Matching Bots step in to fill orders for a small reward.
