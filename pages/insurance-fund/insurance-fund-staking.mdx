...
The Insurance Fund is the protocol's first backstop to maintaining the solvency of the protocol. All users that stake into the IF should read through and be clear on what happens to the Insurance Fund when levered losses and vAMM deficits occur ([**Insurance Fund**](pages/insurance-fund/insurance-fund-intro.mdx)).

## Reward

For providing liquidity to the Insurance Fund, Insurance Fund Stakers are rewarded with their proportionate share of the [**Revenue Pool**](pages/about-v2/revenue-pool.mdx) every hour.  


> The [**Revenue Pool**](pages/about-v2/revenue-pool.mdx) is funded by various aspects of the protocol:  
