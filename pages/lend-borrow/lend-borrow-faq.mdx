...
*   For `initial liability weight` for listed assets, see [**Cross-Collateral Deposits**](/getting-started/cross-collateral-deposits)

**What is the maintenance LTV?**

*   `1/ maintenance liability weight`

*   For `maintenance liability weight` for listed assets, see [**Cross-Collateral Deposits**](/getting-started/cross-collateral-deposits)
