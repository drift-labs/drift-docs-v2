...
*   For `initial liability weight` for listed assets, see [**Cross-Collateral Deposits**](pages/getting-started/cross-collateral-deposits.mdx)

**What is the maintenance LTV?**

*   `1/ maintenance liability weight`

*   For `maintenance liability weight` for listed assets, see [**Cross-Collateral Deposits**](pages/getting-started/cross-collateral-deposits.mdx)
