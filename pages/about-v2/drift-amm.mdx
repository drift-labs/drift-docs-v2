...
Every time a trader wants to fill against the AMM, the AMM will be updated in the same slot with a valid oracle price (see [**Oracles**](pages/trading/oracles.mdx)). 
