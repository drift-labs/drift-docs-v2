...
1.  Spot Trading - [**What is Spot Margin Trading?**](pages/trading/what-is-spot-margin-trading.mdx)

2.  Perpetuals Trading - [**What are Perpetual Futures?**](pages/trading/what-are-perpetual-futures.mdx)

3.  Borrow & Lend - [**What is Borrow & Land?**](pages/lend-borrow/what-is-lend-borrow.mdx)

4.  Passive Liquidity Provision - [**DLP - Drift Liquidity Provider**](pages/providing-liquidity/dlp-drift-liquidity-provider.mdx)
...
_For a more technical breakdown, check out:_[ **Just-in-Time(JIT) Auctions**](pages/about-v2/jit-auctions.mdx)


### Constant Liquidity

Drift's virtual AMM (DAMM) is the backstop designated liquidity provider for trades on the exchange if: 
...
_For a more technical breakdown, check out:_[ **Drift AMM**](pages/about-v2/drift-amm.mdx)
...
Limit orders are placed by users on-chain. A network of Keeper Bots ([**Keeper Bots**](pages/about-v2/keepers.mdx)) then sorts the on-chain limit orders into an off-chain orderbook and categorises limit orders from oldest to newest, and largest to smallest.
...
_For a more technical breakdown, check out:_[ **Decentralised Orderbook FAQ**](pages/about-v2/decentralized-orderbook.mdx).
