...
Drift's decentralised orderbook is powered by our network of [**Keeper Bots**](pages/about-v2/keepers.mdx). 
...
Reference implementations for the filler and trigger Keepers are provided: [**Keeper Bots**](pages/about-v2/keepers.mdx).
