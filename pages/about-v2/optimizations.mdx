...
These rules are systemitised and can be read more under the Margin subheading in [**Cross-Collateral Deposits**](pages/getting-started/cross-collateral-deposits.mdx).  
