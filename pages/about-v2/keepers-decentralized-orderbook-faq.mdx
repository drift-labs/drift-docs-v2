...
A Keeper will track and fill orders and earn a reward. The guide to run is listed in [Keeper Bots](/tutorial-bots/keeper-bots). Incentive structures are listed in [Keeper Incentives](pages/about-v2/keeper-incentives.mdx).
