...
A Keeper will track and fill orders and earn a reward. The guide to run is listed in [**Keeper Bots**](/about-v2/keepers). Incentive structures are listed in [**Keepers & Decentralised Orderbook**](/about-v2/keepers-decentralized-orderbook-faq).
