...
A Keeper will track and fill orders and earn a reward. The guide to run is listed in [**Keeper Bots**](pages/about-v2/keepers.mdx). Incentive structures are listed in [**Keepers & Decentralised Orderbook**](pages/about-v2/keepers-decentralized-orderbook-faq.mdx).
