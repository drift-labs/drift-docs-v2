...
You can read docs here ([**Just-In-Time (JIT) Auctions**](/about-v2/jit-auctions)) as well as read through an example trading bot -- [**JIT Trading Bot**](/developer-resources/tutorial-bots/trading-bots/tutorial-jit-trading-bot).  
...
Yes. We've developed an open-source maker bot that can be accessed [**here**](/developer-resources/tutorial-bots/trading-bots/tutorial-jit-trading-bot). 
