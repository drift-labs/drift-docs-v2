...
Learn more about the ["Life of an Order"](https://hackmd.io/@bigz/Life-of-an-Order-on-Drift) on Drift. See ongoing [discussions](https://github.com/drift-labs/protocol-v2) about liquidity incentives.
