...
Currently, the USDC reward function for keepers (_f_keeper_) is designed as [**formula**](https://archbee.imgix.net/ps_9Ff-LBbQB7IaXI3f3F/7X0tYmUqT218-A0gfXSz-_image.png)
