...
For cancelling orders (that can be cancelled see [**Advanced Orders FAQ**](pages/trading/advanced-orders-faq.mdx)), Keepers will receive the `cancel_order_fee` on the state.
