...
In the case of an extreme [**oracle error**](/trading/oracles): the market will pause most fills, liquidations, and funding rate updates.
</Callout>

If you would like to run a liquidator bot, see [**Tutorial: Liquidation Bot**](/developer-resources/tutorial-bots/keeper-bots/tutorial-liquidation-bot)