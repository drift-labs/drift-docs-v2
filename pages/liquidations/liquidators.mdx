...
Bankruptcy (see [**Insurance Fund**](pages/insurance-fund/insurance-fund-intro.mdx) ) is possible if you still have outstanding liabilities and no further assets after liquidation.  
...
If you would like to run a liquidator bot, see [**Tutorial: Liquidation Bot**](pages/developer-resources/tutorial-bots/keeper-bots/tutorial-liquidation-bot.mdx)