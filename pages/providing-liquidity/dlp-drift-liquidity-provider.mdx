...
As new trades are filled, your DLP positions are updated.

You can manage your risk manually by reducing the DLP position or closing it via the close button in the positions table.
