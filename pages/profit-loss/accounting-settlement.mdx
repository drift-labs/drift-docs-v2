...
(see details of these rules in [**Revenue Pool**](pages/about-v2/revenue-pool.mdx))

The Fee Pool collects exchange fees from swaps and uses them to pay out the Keeper Network [**Keepers & Decentralised Orderbook**](pages/about-v2/keepers-decentralized-orderbook-faq.mdx)
