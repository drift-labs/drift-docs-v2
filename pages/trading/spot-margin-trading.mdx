...
Spot trading on Drift v2 uses liquidity from OpenBook DEX as well as our own DLOB.

<Callout>
By default, margin trading is not enabled. Learn how to enable it [**here**](#enable-spot-margin-trading).
</Callout>
...
![Hover over a market in the top bar](public/assets/z3zW45nt1iU64WvO7O5ZH_screenshot-2023-01-25-at-41736-pm.png)

### Select the direction

Select your direction (e.g. **Buy** or **Sell**) and order type (e.g. **Market**, **Limit**)

### Input the asset amount

Input the asset amount you'd like to trade or the notional value

![Spot trading form](public/assets/26S8LnOdiTA8XLW7Wyfso_screenshot-2023-01-26-at-10913-pm.png)

### Confirm and review

Once you've confirmed your order and it has been filled, your Balances tab will update to reflect your balance changes

![](public/assets/Bxlg-O6wA5YszE4HVwc_O_screenshot-2023-01-26-at-11025-pm.png)
...
![](public/assets/KJFGX4AoQAP3FvuC7jqMn_image.png)
...
![Spot margin trade form](public/assets/zS5jHR786XcbWrsJW4sqh_screenshot-2023-01-26-at-122019-pm.png)
