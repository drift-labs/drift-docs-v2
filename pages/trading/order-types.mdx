...
These orders take against the DAMM and are executed by a decentralised network of keepers, see [**Decentralised Orderbook FAQ**](/about-v2/decentralized-orderbook-faq), once certain conditions are met (i.e. the mark price crosses the specified trigger/limit price).
