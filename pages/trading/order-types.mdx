...
See [**Trading Fees**](pages/trading/trading-fees.mdx) and [**Advanced Orders FAQ**](pages/trading/advanced-orders-faq.mdx) for more information.
...
These orders take against the DAMM and are executed by a decentralised network of keepers, see [**Decentralised Orderbook FAQ**](pages/about-v2/decentralized-orderbook-faq.mdx), once certain conditions are met (i.e. the mark price crosses the specified trigger/limit price).
