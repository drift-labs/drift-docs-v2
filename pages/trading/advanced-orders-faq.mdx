...
Reduce-only means that you can only reduce or close your existing open position and cannot open a new position in the opposite direction. 
...
A Keeper will track and fill orders and earn a reward. Guide to running different types of [**Keeper Bots**](/developer-resources/tutorial-bots/keeper-bots).
