...
Note: Funding rate magnitudes are clamped at 0.12626% and are delayed at large divergences (see [**Oracles**](/trading/oracles)). Individual Market TWAP updates utilize the side of the book for trade executions, Bid and Ask TWAPs in the market are calculated and/or estimated on every trade.
